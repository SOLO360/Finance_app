...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        $stmt->bind_param("sssd", $category, $item_name, $description, $price);
        
        if ($stmt->execute()) {
            $success_message = "Price item added successfully!";
        } else {
            throw new Exception("Error adding price item: " . $stmt->error);
        }
    } catch (Exception $e) {
...
<head>
    ...
    <title>Add Price Item - Finance Tracker</title>
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex justify-between h-16">
                        <div class="flex items-center">
                            <h1 class="text-xl font-bold text-white">Add Price Item</h1>
                        </div>
